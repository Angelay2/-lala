...
当数组中只有2和3重量种类的时候，背包承重在5~10范围, 可以放入5，3~4放入3，2只能放入2 
当数组中只有2，3，5重量种类时，背包承重10, 可以放入10，8~9放入8，7放入7，5~6放入5...

假设有一个能装入容量为C(C在[min,sum]间取值)的背包和n件重量分别为w1,w2,…,wn的物品，能否从n件物品中挑选若干件恰好装满背包，要求输出不满足条件的最小容量。
承重: 2 3 4 5 6 7 8 9 10
当前承重能放入的: 2 2 2 2 2 2 2 2 2 2
已有2和3重量种类时: 3 2 3 3 5 5 5 5 5 5
已有2，3，5重量种类时: 5 2 3 3 5 5 7 8 8 10
